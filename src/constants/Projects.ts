...
export const PROJECTS: Project[] = [
  {
    ...
    tags: ['React', 'Tailwind', 'QuickChart API'],
    year: '2026',
    role: ['Sole Developer'],
    timeline: '1 Night',
  ...
  },
  {
    ...
    tags: ["React", "AWS", "Tailwind", "Vite", "Amplify", "S3", "CloudFront"],
    year: "2025",
  ...
  },
  {
    ...
    tags: ['HTML', 'Tailwind', 'JavaScript', 'goQR.me API', 'PWA'],
    year: '2024',
    role: ['Sole Developer'],
    timeline: '2 Weeks',
  ...
  },
  {
    ...
    tags: ['HTML', 'Tailwind', 'JavaScript', 'Facebook API', 'PWA'],
    year: '2024',
    role: ['Full-Stack Developer'],
    timeline: '1 Week',
  ...
  },
  {
    ...
    tags: ['HTML', 'Tailwind', 'JavaScript', 'CMS'],
    year: '2023',
    role: ['Web Developer'],
    timeline: '6 Weeks',
